...
{$Page}
<br />
{include file="openclas_header.tpl"}
...
<tr>
	...
	<td class='row1' align="center">{$clas[idx].name}</td>
	...
	<td class='row1' align="center"><a href="show.php?permi=1&id={$clas[idx].id}">{$lang.adm_clas_tabl_8}</a></td>
</tr>
{/section}

<link rel="stylesheet" type="text/css" href="css/index.css" />
  <form name="add" method="post" action="categories.php?doedit=1" enctype='multipart/form-data'>
...
<table width="100%" border="0" cellspacing="1" cellpadding="4" align="center">
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="2" align="center">
    ...
    <tr>
      <td width="30%" valign="top" class="row1">{$lang.cat_nb}</td>
      <td width="70%" valign="top" class="row2"><input name="nb" type="text" value="{$nb}"></td>
    </tr>
    <tr>
      <td width="30%" valign="top" class="row1">{$lang.cat_views}</td>
      <td width="70%" valign="top" class="row2"><input name="views" type="text" value="{$views}"></td>
    </tr>
